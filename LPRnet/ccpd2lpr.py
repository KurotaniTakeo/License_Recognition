...
path = r'E:\DataSet\machine_vision\ccpd2019\valid_origin'  # 改成自己的车牌路径
...
for filename in os.listdir(path):
    ...
    cv2.imencode('.jpg', img)[1].tofile(r"E:\DataSet\machine_vision\ccpd2019\valid\{}.jpg".format(result))
    # 图片中文名会报错
    # cv2.imwrite(r"K:\MyProject\datasets\ccpd\new\ccpd_2020\rec_images\valid\{}.jpg".format(result), img)  # 改成自己存放的路径
