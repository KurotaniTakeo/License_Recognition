...
from LPRnet.LPRNet import CHARS, LPRNet
from load_lpr_data import LPRDataLoader
...
def get_parser():
    ...
    parser.add_argument('--pretrained_model', default=r'../weights/lprnet_best.pth', help='pretrained base model')
